...
#property description "EA_Monitor v3.6: 監視・記録 + 月末月初の自動停止 + 足替わりタイマー"
...
int OnInit()
{
   ...
   Print("EA_Monitor v3.6 起動: 監視間隔=", PollSeconds, "秒, TargetMagics=", TargetMagics,
   ...
   Print("EA_Monitor v3.6: ", NextStopWindowText());
...
void SendStartupNotifyOnce()
{
   ...
   string msg = "[EA_Monitor v3.6] 起動しました\n"
