...
B) 実機の3日間に合わせたモデル(ナンピン幅2.00ドル、解析17)で、次の4通りを比べる。
   ...
   稼働停止(新規の初弾だけ止める。持っているバスケットのナンピン・利確は続く):
     ...
     - 月末最終営業日・月初第1営業日は1日中
     - 毎日の閉場前・開場後: 日本時間5:00〜8:00
     - 週明け: 月曜は日本時間11:00まで / 週末: 土曜(金曜の夜明け)日本時間3:00以降
...
YEARS = 2.16
BLOCK = "0,1,2,3,4:5-8;0:7-11;5:3-8"             # 日本時間 曜日(月=0):時-時
